  ...
  return (
    ...
    >
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color }) => (
            <Icon_i name="ios-home-outline" size={25} color={color} />
          ),
          // drawerItemStyle: {
          //     display: "none",
          // },
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color }) => (
            <Icon_i name="ios-settings-outline" size={25} color={color} />
          ),
        }}
      />
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color }) => (
            <Icon_i name="ios-person-outline" size={25} color={color} />
          ),
        }}
      />
    </Drawer.Navigator>
