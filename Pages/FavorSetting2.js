    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.qt_box}>
                <Text style={styles.qt_text}>請選擇3種您用餐時最喜愛的「餐廳種類」</Text>
            </View>
            ...
            <View style={styles.option_row}>
                <View style={styles.option}>
                    ...
                    <CheckBox
                        ...
                        containerStyle={{backgroundColor:"#FDF6DD",borderColor:"#FDF6DD",alignItems:"center"}}
            ...
            <View style={styles.option_row}>
                ...
                <View style={styles.option}>
                    ...
                    <CheckBox
                        ...
                        checkedIcon="dot-circle-o"
                        uncheckedIcon="circle-o"
                        containerStyle={{backgroundColor:"#FDF6DD",width:100,borderColor:"#FDF6DD",alignItems:"center"}}
                        checkedColor="#7B7B7B"
                    />
                </View>
            </View>
